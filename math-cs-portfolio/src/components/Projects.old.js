...
// Alias components to avoid ESLint issues
...
const projects = [
  ...
  },
  {
    ...
    description: 'Interactive platform for visualizing time and space complexity of various algorithms with comparative analysis and Big-O notation explanations.',
    technologies: ['JavaScript', 'D3.js', 'React'],
    image: 'https://source.unsplash.com/random/800x600/?algorithm,visualization',
    github: '#',
    demo: '#',
    featured: true,
    category: 'Education'
  },
  {
    ...
    description: 'Tool for constructing and verifying mathematical proofs using formal logic with support for various proof techniques and theorem libraries.',
    technologies: ['Haskell', 'Coq', 'LaTeX'],
    image: 'https://source.unsplash.com/random/800x600/?mathematics,proof',
    github: '#',
    demo: '#',
    featured: true,
    category: 'Research'
  },
  {
    ...
    description: 'Interactive visualization of fundamental data structures with step-by-step operations and complexity analysis.',
    technologies: ['TypeScript', 'React', 'Visx'],
    image: 'https://source.unsplash.com/random/800x600/?data,structure',
    github: '#',
    demo: '#',
    featured: false,
    category: 'Education'
  },
  {
    ...
    description: 'Web application implementing various numerical methods for root finding, integration, and interpolation with graphical representation.',
    technologies: ['Python', 'Flask', 'Plotly'],
    image: 'https://source.unsplash.com/random/800x600/?calculator,math',
    github: '#',
    demo: '#',
    featured: false,
    category: 'Tool'
